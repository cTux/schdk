...
2. Read `docs/rules/architecture.md` when ownership changes.
3. Reuse existing components and tokens before adding UI surface.
4. Visually smoke-test the affected flow at narrow and normal widths.

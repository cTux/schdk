...
const DEFAULT_QUESTION_DIFFICULTY_DISTRIBUTION: SchdkDictionary = (() => {
  const dictionary = createDistributionDictionary(
    'question-difficulty-distribution',
  ...
  return {
    ...
    items: [
      ...dictionary.items,
      {
        id: 'custom-1785503273873',
        value: 'medium',
        name: 'Mix 0/30/60/10/0',
        description:
          '30% легких питань, 60% середніх питань, 10% складних питань.',
        distribution: {
          'very-easy': 0,
          easy: 30,
          medium: 60,
...
const DEFAULT_SCHDK_DICTIONARIES: readonly SchdkDictionary[] = [
  ...
  DEFAULT_QUESTION_DIFFICULTY_DISTRIBUTION,

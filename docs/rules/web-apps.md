...
- The web application localizes all shell, settings, editor, host, gameplay,
  and visual-editor copy in Ukrainian and English through the shared
  `@schdk/ui` locale context.
...
- Publish the unified web build from `packages/web/dist` to GitHub
